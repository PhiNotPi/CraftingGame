...
The main method is currently in TagData.java.  When run, the code in the static initializer describes the relationships between the possible tags.  Then, in the main method, the entire data structure is printed to the screen to provide a nice visualization.  Next, a couple items are created, and inheritance is used to fill in all the missing properties.
